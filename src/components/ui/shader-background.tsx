...
export default function ShaderBackground(): JSX.Element {
  ...
  const fsSource = `
    ...
    const vec4 lineColor = vec4(0.22, 1.0, 0.73, 1.0);
    ...
    void main() {
      ...
      vec4 lines = vec4(0.0);
      vec4 bgColor1 = vec4(0.02, 0.08, 0.16, 1.0);
      vec4 bgColor2 = vec4(0.07, 0.04, 0.18, 1.0);
